...
def create_menu(drawer):
    ...
    with ui.column().classes('w-full'):
        ...
        ui.button('❄️ Freezer List', on_click=lambda: (ui.navigate.to('/freezer'), drawer.toggle())).props('flat color=primary align=left').classes('w-full')
        ui.button('🗄️ Cabinet List', on_click=lambda: (ui.navigate.to('/cabinet'), drawer.toggle())).props('flat color=primary align=left').classes('w-full')
